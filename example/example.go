...
import (
	...
	"github.com/bitmovin-engineering/m3u8"
	"github.com/bitmovin-engineering/m3u8/example/template"
)
...
func main() {
	...
	m3u8File := "github.com/bitmovin-engineering/m3u8/sample-playlists/media-playlist-with-custom-tags.m3u8"
