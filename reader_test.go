...
func TestDecodeMasterProfile8WithHLSV7(t *testing.T) {
	f, err := os.Open("sample-playlists/master-with-hlsv7-dolby-profile8.m3u8")
	if err != nil {
		t.Fatal(err)
	}
	p := NewMasterPlaylist()
	...
	expected := map[string]VariantParams{
		...
		"dolby_1080/prog_index.m3u8":   {Bandwidth: 12876596, AverageBandwidth: 7999361, Codecs: "dvh1.05.03", Resolution: "1920x1080", Captions: "NONE", VideoRange: "PQ", HDCPLevel: "TYPE-0", FrameRate: 23.976},
		"dolby_2160/prog_index.m3u8":   {Bandwidth: 30041698, AverageBandwidth: 24975091, Codecs: "dvh1.05.06", Resolution: "3840x2160", Captions: "NONE", VideoRange: "PQ", HDCPLevel: "TYPE-1", FrameRate: 23.976},
		"hdr10_720/prog_index.m3u8":    {Bandwidth: 5280654, AverageBandwidth: 3320040, Codecs: "hvc1.2.4.L123.B0", SupplementalCodecs: "dvh1.08.01/db1p", Resolution: "1280x720", Captions: "NONE", VideoRange: "PQ", HDCPLevel: "NONE", FrameRate: 23.976},
		"hdr10_1080/prog_index.m3u8":   {Bandwidth: 12886714, AverageBandwidth: 7964551, Codecs: "hvc1.2.4.L123.B0", SupplementalCodecs: "dvh1.08.01/db1p", Resolution: "1920x1080", Captions: "NONE", VideoRange: "PQ", HDCPLevel: "TYPE-0", FrameRate: 23.976},
		"hdr10_2160/prog_index.m3u8":   {Bandwidth: 29983769, AverageBandwidth: 24833402, Codecs: "hvc1.2.4.L150.B0", SupplementalCodecs: "dvh1.08.01/db1p", Resolution: "3840x2160", Captions: "NONE", VideoRange: "PQ", HDCPLevel: "TYPE-1", FrameRate: 23.976},
		"sdr_720/iframe_index.m3u8":    {Bandwidth: 593626, AverageBandwidth: 248586, Codecs: "hvc1.2.4.L123.B0", Resolution: "1280x720", Iframe: true, VideoRange: "SDR", HDCPLevel: "NONE"},
		"sdr_1080/iframe_index.m3u8":   {Bandwidth: 956552, AverageBandwidth: 399790, Codecs: "hvc1.2.4.L123.B0", Resolution: "1920x1080", Iframe: true, VideoRange: "SDR", HDCPLevel: "TYPE-0"},
		"sdr_2160/iframe_index.m3u8":   {Bandwidth: 1941397, AverageBandwidth: 826971, Codecs: "hvc1.2.4.L150.B0", Resolution: "3840x2160", Iframe: true, VideoRange: "SDR", HDCPLevel: "TYPE-1"},
		"dolby_720/iframe_index.m3u8":  {Bandwidth: 573073, AverageBandwidth: 232253, Codecs: "dvh1.05.01", Resolution: "1280x720", Iframe: true, VideoRange: "PQ", HDCPLevel: "NONE"},
		"dolby_1080/iframe_index.m3u8": {Bandwidth: 905037, AverageBandwidth: 365337, Codecs: "dvh1.05.03", Resolution: "1920x1080", Iframe: true, VideoRange: "PQ", HDCPLevel: "TYPE-0"},
		"dolby_2160/iframe_index.m3u8": {Bandwidth: 1893236, AverageBandwidth: 739114, Codecs: "dvh1.05.06", Resolution: "3840x2160", Iframe: true, VideoRange: "PQ", HDCPLevel: "TYPE-1"},
		"hdr10_720/iframe_index.m3u8":  {Bandwidth: 572673, AverageBandwidth: 232511, Codecs: "hvc1.2.4.L123.B0", SupplementalCodecs: "dvh1.08.01/db1p", Resolution: "1280x720", Iframe: true, VideoRange: "PQ", HDCPLevel: "NONE"},
		"hdr10_1080/iframe_index.m3u8": {Bandwidth: 905053, AverageBandwidth: 364552, Codecs: "hvc1.2.4.L123.B0", SupplementalCodecs: "dvh1.08.01/db1p", Resolution: "1920x1080", Iframe: true, VideoRange: "PQ", HDCPLevel: "TYPE-0"},
		"hdr10_2160/iframe_index.m3u8": {Bandwidth: 1895477, AverageBandwidth: 739757, Codecs: "hvc1.2.4.L150.B0", SupplementalCodecs: "dvh1.08.01/db1p", Resolution: "3840x2160", Iframe: true, VideoRange: "PQ", HDCPLevel: "TYPE-1"},
	}
	for _, variant := range p.Variants {
		var found bool
		for uri, vp := range expected {
...
func TestMediaPlaylistWithOATCLSAndCueInTag(t *testing.T) {
	f, err := os.Open("sample-playlists/media-playlist-with-oatcls-scte35-cue-in.m3u8")
	if err != nil {
		t.Fatal(err)
	}
	p, _, err := DecodeFrom(bufio.NewReader(f), true)
...
func ExampleMediaPlaylist_FairPlay_only() {
	f, _ := os.Open("sample-playlists/fairplay.m3u8")
	p, _, _ := DecodeFrom(bufio.NewReader(f), true)
	pp := p.(*MediaPlaylist)
	fmt.Print(pp)
	// Output:
	// #EXTM3U
	// #EXT-X-VERSION:2
	// #EXT-X-KEY:METHOD=SAMPLE-AES,URI="skd://vtg.stage.ott.irdeto.com/licenseServer/streaming/v1/vtg/getckc?contentId=BP_test_1&keyId=5dbc6664-600a-4a90-9be8-49ac816310fd",KEYFORMAT="com.apple.streamingkeydelivery",KEYFORMATVERSIONS="1"
...
func ExampleMediaPlaylist_PlayReady_and_FairPlay() {
	f, _ := os.Open("sample-playlists/playread_and_fairplay.m3u8")
	p, _, _ := DecodeFrom(bufio.NewReader(f), true)
	pp := p.(*MediaPlaylist)
	fmt.Print(pp)
	// Output:
	...
	// #EXT-X-VERSION:2
	// #EXT-X-KEY:METHOD=SAMPLE-AES,URI="skd://vtg.stage.ott.irdeto.com/licenseServer/streaming/v1/vtg/getckc?contentId=BP_test_1&keyId=5dbc6664-600a-4a90-9be8-49ac816310fd",KEYFORMAT="com.apple.streamingkeydelivery",KEYFORMATVERSIONS="1"
	// #EXT-X-KEY:METHOD=SAMPLE-AES,URI="data:text/plain;charset=UTF-16;base64,",KEYFORMAT="com.microsoft.playready",KEYFORMATVERSIONS="1"
	// #EXT-X-MEDIA-SEQUENCE:3080
	// #EXT-X-TARGETDURATION:9
	// #WV-AUDIO-CHANNELS 2
	// #WV-AUDIO-FORMAT 1
...
func ExampleMediaPlaylist_PlayReady_Widevine_and_FairPlay() {
	f, err := os.Open("sample-playlists/playread_widevine_and_fairplay.m3u8")
	if err != nil {
	...
	pp, ok := p.(*MediaPlaylist)
	if !ok {
		fmt.Println("Error: decoded playlist is not a MediaPlaylist")
		return
	}
	...
	// #EXTM3U
	// #EXT-X-VERSION:2
	// #EXT-X-KEY:METHOD=SAMPLE-AES,URI="skd://vtg.stage.ott.irdeto.com/licenseServer/streaming/v1/vtg/getckc?contentId=test_1&keyId=5dbc6664-600a-4a90-9be8-49ac816310fd",KEYFORMAT="com.apple.streamingkeydelivery",KEYFORMATVERSIONS="1"
	// #EXT-X-KEY:METHOD=SAMPLE-AES,URI="data:text/plain;base64,AAAAOHBzc2gAAAAAZWRlZjhiYTk3OWQ2NGFjZQAAABgSEF28ZmRgCkqQm+hJrIFjEP1I88aJmwY=",KEYFORMAT="urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed",KEYFORMATVERSIONS="1"
	// #EXT-X-KEY:METHOD=SAMPLE-AES,URI="data:text/plain;charset=UTF-16;base64,",KEYFORMAT="com.microsoft.playready",KEYFORMATVERSIONS="1"
	// #EXT-X-MEDIA-SEQUENCE:3080
	// #EXT-X-TARGETDURATION:9
	// #WV-AUDIO-CHANNELS 2
